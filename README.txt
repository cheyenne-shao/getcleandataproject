...
- 'average.txt': average of the complete dataset(from 'train/X_train.txt' and 'test/X-test.txt') on the variables with parameter mean and parameter standard deviation (std). It is grouped by the 6 activities and 30 volunteers
